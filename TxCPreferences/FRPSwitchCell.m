...
+ (instancetype)cellWithTitle:(NSString *)title subTitle:(NSString *)subTitle setting:(FRPSettings *)setting postNotification:(NSString *)notification changeBlock:(FRPSwitchCellChanged)block {
    return [[self alloc] cellWithTitle:title subTitle:subTitle setting:setting postNotification:notification changeBlock:block];
}

- (instancetype)cellWithTitle:(NSString *)title subTitle:(NSString *)subTitle setting:(FRPSettings *)setting postNotification:(NSString *)notification changeBlock:(FRPSwitchCellChanged)block {
    FRPSwitchCell *cell = [super initWithTitle:title subTitle:subTitle setting:setting];
