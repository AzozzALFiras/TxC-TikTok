...
self.AFSoicalButtonTikTok.frame = CGRectMake(self.view.frame.size.width - 35 - 10, 250.0, 30.0, 30.0);
...
NSString *ImageProfileUrl = [self.user.avatarThumb.originURLList objectAtIndex:0];
